                ...
                <div class="row" data-masonry='{"percentPosition": true }'>
                    ...
                    if ($result->num_rows > 0) {
                        foreach ($result as $row) {
                            ...
                            <a href="view_artwork-admin.php?id=' . $row["_id"] . '" class="card-art-image d-block">
                            ...
                            <div class="card-art-footer">
                                <a href="view_artwork-admin.php?id=' . $row["_id"] . '" class="card-footer-link"><span class="alt-text">View more</span></a>
                            </div>
                        </div>';
                        }
                    } else {
